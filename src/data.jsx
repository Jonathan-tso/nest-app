...
const PEOPLE = [
  { id: "you", name: "מאיה",  color: "pink", short: "את"  },
  { id: "noa", name: "נועה",  color: "mint", short: "נועה" },
];

const EXPENSES_MAY = [
  { id: "e1",  category: "groceries",   label: "שופרסל",            amount: 287.40, date: "21 במאי", paidBy: "you", split: 50, note: "קניה שבועית" },
  ...
  { id: "e6",  category: "transport",   label: "יאנגו — נתב״ג",      amount: 124.00, date: "12 במאי", paidBy: "you", split: 50 },
  ...
  { id: "e12", category: "household",   label: "איקאה — מנורה",       amount: 189.00, date: "3 במאי",  paidBy: "noa", split: 50 },
];
...
const BILLS = [
  ...
  { id: "b4", category: "internet",    label: "בזק",                 amount: 99,    dueDate: "8 ביוני", dueIso: "2026-06-08", status: "upcoming", recurring: "חודשי", assignee: "you", paid: false },
  ...
  { id: "b6", category: "health",      label: "כללית מושלם",         amount: 142,   dueDate: "30 במאי", dueIso: "2026-05-30", status: "upcoming", recurring: "חודשי", assignee: "you" },
  { id: "b7", category: "tv",          label: "ספוטיפיי משפחה",      amount: 39.90, dueDate: "12 ביוני", dueIso: "2026-06-12", status: "upcoming", recurring: "חודשי", assignee: "you" },
  { id: "b8", category: "rent",        label: "ועד בית",             amount: 320,   dueDate: "5 ביוני",  dueIso: "2026-06-05", status: "upcoming", recurring: "חודשי", assignee: "noa" },
];
...
const GROCERY_INIT = [
  ...
  { id: "g3", section: "produce",  name: "אבוקדו",       qty: "3 בשלים",   addedBy: "you", checked: false },
  { id: "g4", section: "produce",  name: "לימונים",      qty: "5",         addedBy: "noa", checked: true },
  { id: "g5", section: "produce",  name: "נענע",         qty: "צרור",      addedBy: "ai",  checked: false, suggested: true },
  { id: "g6", section: "dairy",    name: "יוגורט יווני",  qty: "500 ג׳",    addedBy: "you", checked: false },
  { id: "g7", section: "dairy",    name: "קוטג׳ 5%",      qty: "2",         addedBy: "noa", checked: false },
  { id: "g8", section: "dairy",    name: "פטה",          qty: "200 ג׳",    addedBy: "you", checked: false },
  { id: "g9", section: "dairy",    name: "חלב שיבולת",   qty: "1 ליטר",    addedBy: "ai",  checked: false, suggested: true },
  { id: "g10", section: "bakery",  name: "מחמצת",         qty: "כיכר",      addedBy: "you", checked: false },
  ...
  { id: "g14", section: "pantry",  name: "פסטה",          qty: "2 חבילות",  addedBy: "ai",  checked: false, suggested: true },
...
const AI_INSIGHTS = [
  {
    id: "i1",
    headline: "את 18% מתחת לתקציב הקניות במאי",
    body: "₪491 מתוך ₪600 — אם תמשיכי בקצב הזה תחסכי ₪215 לעומת אפריל.",
    tone: "good",
  },
  {
    id: "i2",
    headline: "נועה שילמה יותר החודש",
    body: "היא כיסתה ₪612 יותר ממך. אולי כדאי לסגור חשבון לפני סוף החודש?",
    cta: "סגירת חשבון",
    tone: "neutral",
  },
  {
    id: "i3",
    headline: "הוצאות על מסעדות עלו ב-34%",
    body: "כבר ₪164 לעומת ₪122 באפריל. נשארו 8 ימים לסוף החודש.",
    tone: "warn",
  },
];

const NOTIFICATIONS = [
  { id: "n1", kind: "overdue",  who: "Nest", time: "לפני שעתיים", title: "נטפליקס בפיגור", body: "₪54.90 היו אמורים להיגבות אתמול. נועה רשומה כמשלמת.", read: false },
  ...
  { id: "n3", kind: "ai",       who: "Nest AI", time: "אתמול", title: "זיהיתי חשבון בזק במייל שלך", body: "הוספתי ₪99 לחשבונות החוזרים (שולם ב-8 במאי).", read: true },
  { id: "n4", kind: "settle",   who: "מאיה", time: "לפני יומיים", title: "שילמת לנועה ₪240", body: "סגירת חשבון לחצי הראשון של מאי.", read: true },
  { id: "n5", kind: "reminder", who: "Nest", time: "לפני 3 ימים", title: "חשבון חשמל בעוד 5 ימים", body: "₪380 — נועה אחראית על התשלום.", read: true },
];
...
const CHAT_SEED = [
  { id: "c0", from: "ai", text: "היי מאיה, שלחי לי קבלה או פשוט תספרי לי על מה הוצאת — אני ארשום." },
];
